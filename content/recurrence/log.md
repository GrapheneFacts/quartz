---
title: Recurrence log
description: Items that are not new — resurfaced, repeated, or revisited.
tags:
  - recurrence
---
...
When a pull finds something **not new**: bump last seen; only create a new topic file when there is new evidence.

Source: [recurrence/log.md](https://github.com/GrapheneFacts/graphene-archive/blob/main/recurrence/log.md)
